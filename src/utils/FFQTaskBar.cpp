...
const GUID FF_CLSID_TaskbarList = {0x56fdf344, 0xfd6d, 0x11d0, { 0x95, 0x8a, 0x00, 0x60, 0x97, 0xc9, 0xa0, 0x90 }};
...
FFQTaskBar::FFQTaskBar()
{
    ...
    m_TaskbarList = NULL;
    CoCreateInstance(FF_CLSID_TaskbarList, NULL, CLSCTX_INPROC_SERVER, IID_ITaskbarList3, (LPVOID*)&m_TaskbarList);
